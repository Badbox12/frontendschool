...
// 🔙 Logout Action
export const logoutUser = createAsyncThunk<null, void, { rejectValue: string }>("auth/logoutUser", async (_, { rejectWithValue }) => {
  try {
...
export const verifyToken = createAsyncThunk<AuthState["user"], void, { rejectValue: string }>("auth/verifyToken", async (_, { rejectWithValue }) => {
